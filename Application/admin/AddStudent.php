                                        ...
                                        <div class="modal-content">
                                            ...
                                            <br>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="phone-id" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="phone">Parent Email:</label>
                                                    <input type="text" class="form-control" id="email-id" required>
                                                </div>

                                                <div class="form-group">
                                                    <label for="username">Username:</label>
                                                    <input type="text" class="form-control" id="username-id" required>
                                                </div>
                ...
                <div id="new" class="tab-pane fade">
                    ...
                    <form action="code.php" method="POST">
                        ...
                        <div class="textfield " style="margin: 5% 15% 5% 15% ">
                            ...
                            <div class="input-group col-md-12">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                <input id="parent-phone" type="text" class="form-control" name="parent-phone-name" placeholder="Parent Phone" required>
                            </div>
