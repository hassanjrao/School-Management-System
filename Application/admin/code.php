...
if ($_SESSION["login_admin"] == null) {
    ...
    if (isset($_POST['class_hid'])) {
        ...
        $query = "UPDATE class_tb SET  class_name='$class_name' WHERE class_id='$class_id'";
        $query_run = mysqli_query($connection, $query);
        ...
        if (mysqli_num_rows($query_run) == 0) {
            ...
            if (mysqli_num_rows($query_run) > 0) {
                ...
                if ($count_id == 0) {
                    ...
                    $parent_id = $count_id['total'] + 3; ///incrementing parent id to one for the next parent
                }
    ...
    if (isset($_POST["btn-add-class"])) {
        ...
        $query = "INSERT INTO class_tb (class_name) Values('$class')";
